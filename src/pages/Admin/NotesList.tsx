            ...
            <div className={cn(
              ...
              {filteredNotes.map((note) => (
                <motion.div
                  ...
                  className={cn(
                    "group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 transition-all hover:shadow-md relative",
                    viewMode === 'grid' ? "rounded-2xl p-6" : "rounded-xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4"
                  )}
                >
                  <div className={cn("flex flex-col gap-1", viewMode === 'list' && "flex-1 min-w-0")}>
                    ...
                    <p className={cn(
                      ...
                      viewMode === 'grid' ? "text-sm mb-6 line-clamp-6" : "text-xs truncate max-w-2xl"
                    )}>
                      {note.content}
                    </p>
                  </div>
                  ...
                  <div className={cn(
                    viewMode === 'grid' 
                      ...
                      : "flex flex-col md:flex-row md:items-center gap-3 shrink-0"
                  )}>
                    <div className="flex items-center gap-2 text-xs font-medium text-indigo-600 dark:text-indigo-400">
                      <User className="w-3.5 h-3.5" />
                      <span className="truncate max-w-[120px]">{getClienteName(note.cliente_id)}</span>
                    </div>
                    ...
                    {viewMode === 'list' && (
                      <div className="flex items-center gap-1 md:ml-4 border-l pl-4 dark:border-slate-800">
                        <button
                          onClick={() => handleOpenModal(note)}
                          className="p-2 text-slate-400 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/10 rounded-lg transition-colors"
                        >
